...
import { CalendarCheck, UtensilsCrossed, Users, BadgeCheckIcon, Globe2Icon, ClockCheckIcon } from 'lucide-react'

const STATS = [
    { icon: BadgeCheckIcon, value: '12+', label: 'projects delivered' },
    { icon: Globe2Icon, value: '8', label: 'Countries' },
    { icon: ClockCheckIcon, value: '100%', label: 'on-time rate' },
]
